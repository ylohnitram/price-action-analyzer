...
def parse_arguments():
    ...
    parser.add_argument('--multi', action='store_true',
                        help='Použít multi-timeframe analýzu')
...
def run_multi_timeframe_analysis(symbol):
    """
    Spustí analýzu pro více časových rámců.
    ...
    logger.info(f"Spouštím multi-timeframe analýzu pro {symbol}")
    ...
    try:
        ...
        logger.info("Stahuji multi-timeframe data z Binance")
        ...
        # Generování analýzy
        logger.info("Generuji multi-timeframe AI analýzu")
        analysis = analyzer.generate_multi_timeframe_analysis(symbol, dataframes)
        
        # Odeslání výsledků
        message = f"**Multi-Timeframe Price Action Analýza {symbol}**\n\n{analysis}"
        ...
        logger.info("Multi-timeframe analýza úspěšně dokončena")
        return True
        
    except Exception as e:
        logger.error(f"Chyba během multi-timeframe analýzy: {str(e)}")
        return False
...
def main():
    ...
    try:
        if args.multi:
            logger.info("Spouštím multi-timeframe analýzu")
